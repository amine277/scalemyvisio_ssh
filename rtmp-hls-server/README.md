...
The provided demo players assume the stream-key is called `test` and the player is opened in 159.65.183.139. 
	* To play RTMP content (requires Flash): `http://159.65.183.139:8080/players/rtmp.html` 
	* To play HLS content: `http://159.65.183.139:8080/players/hls.html`
	* To play HLS content using hls.js library: `http://159.65.183.139:8080/players/hls_hlsjs.html`
	* To play DASH content: `http://159.65.183.139:8080/players/dash.html`
	* To play RTMP and HLS contents on the same page: `http://159.65.183.139:8080/players/rtmp_hls.html`

	**Notes:** 

	* These web players are hardcoded to play stream key "test" at 159.65.183.139.
